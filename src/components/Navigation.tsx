      ...
      <div className={`transition-all duration-300 ${
        ...
        <div className="flex justify-between items-center">
          ...
          >
            ...
            <div className="text-white font-['Gilmer']">
              <div className="font-bold text-lg">Koech</div>
              <div className="text-xs text-[#ff4940]">Builder & Creative</div>
            </div>
          </motion.div>
          ...
          <button
            ...
            className="md:hidden text-white p-2 rounded-full hover:bg-[#ff4940]/20"
          >
            ...
            >
              {navItems.map((item, index) => (
                <motion.button
                  ...
                  onClick={() => scrollToSection(item.href)}
                  className="block w-full text-left py-3 px-4 text-gray-300 hover:text-white hover:bg-[#ff4940]/10 rounded-full mx-2 mb-2 transition-all duration-200 font-['Gilmer']"
                >
                  {item.label}
                </motion.button>
              ))}
