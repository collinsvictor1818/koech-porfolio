    ...
    <section id="contact" className="py-20 px-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            <div>
              <h3 className="text-2xl font-bold text-theme-primary mb-6 font-['Gilmer']">Get in Touch</h3>
              <p className="text-theme-secondary mb-8 leading-relaxed font-['Gilmer']">
              ...
              {contactInfo.map((contact, index) => (
                ...
                >
                  {contact.href ? (
                    <a
                      href={contact.href}
                      className="flex items-center space-x-4 p-4 bg-glass rounded-full border border-glass hover:border-accent/50 transition-all duration-300"
                    >
                      ...
                      <div>
                        <div className="text-sm text-theme-muted font-['Gilmer']">{contact.label}</div>
                        <div className="text-theme-primary font-medium font-['Gilmer']">{contact.value}</div>
                      </div>
                    </a>
                  ) : (
                    <div className="flex items-center space-x-4 p-4 bg-glass rounded-full border border-glass">
            ...
            {/* Social Links */}
            <div>
              <h4 className="text-lg font-semibold text-theme-primary mb-4 font-['Gilmer']">Connect on Social</h4>
              <div className="space-y-3">
                {socialLinks.map((social, index) => (
                  <motion.a
                    ...
                    transition={{ duration: 0.5, delay: index * 0.1 }}
                    viewport={{ once: true }}
                    className="flex items-center space-x-3 p-3 bg-glass rounded-full border border-glass hover:border-accent/50 transition-all duration-300 group"
                  >
                    ...
                    <div>
                      <div className="text-sm text-theme-muted font-['Gilmer']">{social.label}</div>
                      <div className="text-theme-primary text-sm font-['Gilmer']">{social.value}</div>
                    </div>
                  </motion.a>
                ))}
              </div>
          ...
          >
            ...
            <div className="bg-accent/10 rounded-3xl p-6 border border-accent/20">
              <div className="flex items-center space-x-3 mb-4">
                ...
                <h3 className="text-xl font-bold text-theme-primary font-['Gilmer']">Available for Work</h3>
              </div>
              <p className="text-theme-secondary mb-4 font-['Gilmer']">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                {availabilityItems.map((item, index) => (
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    className="flex items-center space-x-2 text-sm text-theme-secondary font-['Gilmer']"
                  >
            ...
            {/* Quick Actions */}
            <div className="bg-glass rounded-3xl p-6 border border-glass">
              <h3 className="text-xl font-bold text-theme-primary mb-4 font-['Gilmer']">Quick Actions</h3>
              <div className="space-y-4">
                <Button
                  className="w-full bg-accent hover:bg-accent/80 text-white py-3 rounded-full font-medium flex items-center justify-center space-x-2 font-['Gilmer']"
                ...
                <Button
                  variant="outline"
                  className="w-full border-accent text-accent hover:bg-accent/10 py-3 rounded-full font-medium flex items-center justify-center space-x-2 font-['Gilmer']"
                >
                ...
                <Button
                  variant="outline"
                  className="w-full border-theme-secondary text-theme-secondary hover:bg-accent/10 py-3 rounded-full font-medium flex items-center justify-center space-x-2 font-['Gilmer']"
            ...
            {/* Response Time */}
            <div className="bg-glass rounded-3xl p-6 border border-glass">
              <h4 className="font-semibold text-theme-primary mb-3 font-['Gilmer']">Response Time</h4>
        ...
        >
          <div className="max-w-4xl mx-auto p-8 bg-glass rounded-3xl border border-accent/20">
            <h3 className="text-2xl font-bold text-theme-primary mb-4 font-['Gilmer']">Ready to Start Your Next Project?</h3>
            <p className="text-theme-secondary mb-6 max-w-2xl mx-auto font-['Gilmer']">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              <Button
                className="bg-accent hover:bg-accent/80 text-white px-8 py-3 rounded-full font-medium transform hover:scale-105 transition-all duration-300 font-['Gilmer']"
